        ...
        <div style="width: 1000px; margin: 20px;">
            <h3>Dish Name</h3>
                <div class="form-group">
                    <input class="form-control" type="text" name="DishName" placeholder="DishName" required>
                </div>
                <h3>Category</h3>
                <div class="form-group">
...
<div class="container">
        ...
        <textarea rows="15" cols="130" name="Steps" placeholder="Add Instructions.!"></textarea>
        </div>
         <div class="submiddle">
